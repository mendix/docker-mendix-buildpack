...
- **CF_BUILDPACK** is a version of CloudFoundry buildpack. Defaults to `v4.27.0`. For stable pipelines, it's recommended to use a fixed version from **v4.24.0** and later. CloudFoundry buildpack versions below **v4.24.0** are not supported.
