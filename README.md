...
- **CF_BUILDPACK** is a version of CloudFoundry buildpack. Defaults to `v5.0.31`. For stable pipelines, it's recommended to use a fixed **v5.0.31** version. Other Cloud Foundry buildpacks might not work with this version of Docker Buildpack.
