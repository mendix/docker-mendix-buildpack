...
- **CF_BUILDPACK** is a version of CloudFoundry buildpack. Defaults to `v4.23.3`. For stable pipelines, it's recommended to use a fixed version from **v4.23.3** and later. CloudFoundry buildpack versions below **v4.23.3** are not supported.
