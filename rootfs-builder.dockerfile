...
RUN rpm -ivh https://dl.fedoraproject.org/pub/epel/epel-release-latest-8.noarch.rpm &&\
    ...
    microdnf install -y wget curl glibc-langpack-en python311 python3-setuptools python3.11-pip python3.11-devel openssl libgdiplus tar gzip unzip libpq nginx nginx-mod-stream binutils fontconfig libicu findutils libffi-devel gcc && \
